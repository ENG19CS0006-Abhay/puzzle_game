...
export class GroqService {
  ...
  async generatePuzzle(difficulty: 'easy' | 'medium' | 'hard'): Promise<string> {
    ...
    const prompt = `
You are creating a murder mystery case for Detective Jency Infantcia, a brilliant finance expert who left Wall Street to solve crimes. She has an exceptional eye for detail and logical prowess.
